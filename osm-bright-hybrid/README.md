...
This map is based on OSM Bright, but I have just removed the land and water in order to
generate a hybrid map that it can be used as overlay on satellite maps.
